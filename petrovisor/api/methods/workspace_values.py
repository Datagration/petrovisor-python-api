...
class WorkspaceValueMixinHelper:
    ...
    ENDPOINT_ALL = "ConfigurationSettings/All"
    ENDPOINT_RENAME = "ConfigurationSettings/Rename"
...
class WorkspaceValuesMixin(SupportsRequests):
    ...
    def get_workspace_values(
        ...
        if value_type:
            ...
            values = self.get(WorkspaceValueMixinHelper.ENDPOINT_ALL, **kwargs)
        return {
    ...
    def rename_workspace_value(self, old_name: str, new_name: str, **kwargs) -> Dict:
        ...
        """
        return self.post(
            WorkspaceValueMixinHelper.ENDPOINT_RENAME,
            query={
                "OldName": old_name,
                "NewName": new_name,
            },
